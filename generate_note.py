...
.page-title{font-family:'Malgun Gothic','맑은 고딕',system-ui,sans-serif;font-size:1.9rem;font-weight:800;color:#1a1a2e;letter-spacing:-.01em;text-shadow:none;line-height:1.3;}
.page-subtitle{font-family:'Malgun Gothic','맑은 고딕',system-ui,sans-serif;font-size:1.05rem;color:#666;opacity:1;margin-top:5px;letter-spacing:0;animation:none;}
.month-label{font-family:'Malgun Gothic','맑은 고딕',system-ui,sans-serif;font-size:1.2rem;font-weight:700;color:#1a1a2e;min-width:110px;text-align:center;}
.cal-nav{background:#fff;border:1px solid #d0d7de;border-radius:8px;cursor:pointer;padding:5px 16px;font-size:1rem;color:#555;transition:all .15s;}
.cal-nav:hover{background:#e8f0fe;border-color:#aaa;color:#333;}
...
@media(max-width:700px){.page-title{font-size:1.3rem;}.page-subtitle{font-size:.88rem;}}
</style>
</head>
<body>
<div class="page">
