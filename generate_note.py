...
.calendar-grid-7{display:grid;grid-template-columns:repeat(7,minmax(0,1fr));gap:6px;grid-auto-rows:minmax(100px,auto);}
...
.cal-day{border:1.5px solid #ddd;padding:7px;background:#fff;display:flex;flex-direction:column;justify-content:space-between;transition:all 0.15s;cursor:default;min-width:0;overflow:hidden;}
...
.cal-day-zombie{display:block;text-align:center;font-size:2.2rem;margin-top:4px;line-height:1;}
